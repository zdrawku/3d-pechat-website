...
export class VidoveFilamentZa3dPrintiraneKakDaIzberetePravilniyaMaterialComponent implements OnInit {
  ...
  constructor(
    ...
    this.seoService.updateSeo({
      ...
      keywords: 'филамент за 3D принтиране, видове филамент, PLA филамент, PETG, ABS, TPU, 3D печат материали, как да изберем филамент, 3D принтер България',
      ...
      publishedDate: new Date('2026-09-01').toISOString(),
      modifiedDate: new Date('2026-09-01').toISOString()
    });
